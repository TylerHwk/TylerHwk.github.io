...
/**
 * Defines the boxes that will hold the letters
 */
var letterBox;
...
/**
 * Defines the buttons that will display the letters
 * along with the delete and enter buttons
 */
var letterButton;
...
/**
 * Styles the background of the screen
 */
...
title.innerHTML = "Wordle Z<sub>9</sub>";
//title.style.color = "#B026FF";
title.style.textAlign = "center";
//title.style.borderBottom = "thin #fff solid";
...
/**
 * Creates the div that will hold the letter boxes
 */
...
/**
 * Creates the div that will hold the letter buttons
 */
...
/**
 * Creates the box that will hold the letter
 * @param {} letter 
 * @param {*} xPos 
 * @param {*} yPos 
 * @param {*} id 
...
function makeLetterBox(letter, xPos, yPos, id){
    ...
    letterBox.style.border = "#ff073a thin solid";
    ...
    letterBox.style.borderRadius = '2px';
    letterDiv.append(letterBox);
}

/**
 * Creates the buttons that display the letters along with 
 * the delete and enter buttons
 */
 function makeLetterButton(letter, xPos, yPos, id, w, type){
    ...
    letterButton.style.backgroundColor = "#1f51ff";
    ...
    letterButton.id = id;
    letterButton.className = "letters";
...
/**
 * Creates the first row of boxes that will hold the letters
 * the user selects
 */
...
/**
 * Makes the first row of letter buttons
 */
...
/**
 * Makes the second row of letter buttons
 */
...
/**
 * Makes the third row of letter buttons
 */
...
/**
 * This global variable is useful for keeping track of where you are on the grid
 */
